...
server {
    ...
    ssl_ciphers 'ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-CHACHA20-POLY1305:ECDHE-RSA-CHACHA20-POLY1305:DHE-RSA-AES128-GCM-SHA256:DHE-RSA-AES256-GCM-SHA384:AES128-GCM-SHA256:AES256-GCM-SHA384:ECDHE-RSA-AES128-SHA:ECDHE-RSA-AES256-SHA:AES128-SHA:AES256-SHA:DES-CBC3-SHA';
...
`;
  conn.exec(`cat << 'EOF' > /etc/nginx/sites-available/ladoga-park\n${conf}\nEOF\nsystemctl restart nginx`, (err, stream) => {
    ...
    stream.on('close', () => {
      console.log('✅ Applied MAXIMUM SSL CIPHER COMPATIBILITY to Nginx!');
      conn.end();
    });
  });
